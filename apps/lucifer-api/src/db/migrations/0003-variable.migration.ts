...
export class Variable0003Migration implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
          `CREATE TABLE "variable" ("adminId" character varying NOT NULL, "projectId" character varying(100) NOT NULL, "id" character varying(100) NOT NULL, "name" character varying(100) NOT NULL, "value" text NOT NULL, CONSTRAINT "PK_0f4b727d2f7186acf29053048a3" PRIMARY KEY ("adminId", "projectId", "id"))`);
